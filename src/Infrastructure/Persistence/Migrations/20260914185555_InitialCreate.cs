        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestTypes_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproverTargetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogicGroup = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalInstances_Roles_AssignedRoleId",
                        column: x => x.AssignedRoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalInstances_WorkflowSteps_WorkflowStepId",
                        column: x => x.WorkflowStepId,
                        principalTable: "WorkflowSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Delegations_RequestTypes_RequestTypeId",
                        column: x => x.RequestTypeId,
                        principalTable: "RequestTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_WorkflowVersions_WorkflowVersionId",
                        column: x => x.WorkflowVersionId,
                        principalTable: "WorkflowVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_ActorUserId",
                table: "ApprovalActions",
                column: "ActorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_ApprovalInstanceId",
                table: "ApprovalActions",
                column: "ApprovalInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalInstances_AssignedRoleId",
                table: "ApprovalInstances",
                column: "AssignedRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalInstances_AssignedUserId",
                table: "ApprovalInstances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalInstances_WorkflowStepId",
                table: "ApprovalInstances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delegations_DelegatorUserId_IsActive",
                table: "Delegations",
                columns: new[] { "DelegatorUserId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Delegations_RequestTypeId",
                table: "Delegations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_WorkflowVersionId",
                table: "Requests",
                column: "WorkflowVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestTypes_OrganizationId_Code",
                table: "RequestTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowSteps_WorkflowVersionId_StepNumber",
                table: "WorkflowSteps",
                columns: new[] { "WorkflowVersionId", "StepNumber" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalActions_Users_ActorUserId",
                table: "ApprovalActions",
                column: "ActorUserId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalInstances_Requests_RequestId",
                table: "ApprovalInstances",
                column: "RequestId",
                principalTable: "Requests",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalInstances_Users_AssignedUserId",
                table: "ApprovalInstances",
                column: "AssignedUserId",
                principalTable: "Users",
                principalColumn: "Id",
